...
* Clone this repository inside your Saber project within `/App/Vendors/` and name the folder **Market**
...
* Download latest release of [Saber.Vendors.Market](https://github.com/Datasilk/Saber-Market/releases)
...
* publish `bin/Publish/Market.7z` as latest release